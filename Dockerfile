...
RUN apt install -y gnupg apt-transport-https ca-certificates python-pip wget && \
...
RUN cd /tmp && wget -q https://packages.microsoft.com/config/ubuntu/19.04/packages-microsoft-prod.deb -O packages-microsoft-prod.deb && \
